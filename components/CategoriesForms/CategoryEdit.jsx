...
const CategoryEdit = ({id, category: categoryServerData}) => {
    // STATES
    ...
    //EFFECT TO SET THE DATE TO CATEGORY WHEN PAGE LOAD
    useEffect(() => {
        setCategory({
            categoryType: categoryServerData.sectionType,
            categoryTitle: categoryServerData.sectionTitle,
            categorySubTitle: categoryServerData.sectionSubtitle,
            parentSectionId: categoryServerData.parentSectionId,
            sectionOrder: categoryServerData.sectionOrder,
            sectionPrice: categoryServerData.sectionPrice,
            files: [],
            currency: categoryServerData.currency,
        })
    }, [categoryServerData]);
    ...
    const handleSubmit = (e) => {
        ...
        formData.append("sectionPrice", category.sectionPrice);
    ...
    return (
        <>
            <form onSubmit={handleSubmit} className={"col-12 card"}>
                <h1 className="text-2xl mb-5 uppercase">Edit Category</h1>
                ...
                <div className="p-fluid formgrid grid">
                    ...
                    <div className="field col-12">
                        ...
                        <CustomFileInput accept={'.jpg, .jpeg, .png, .gif'}
