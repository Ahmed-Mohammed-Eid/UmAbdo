...
const MediaEdit = ({id, media: mediaDataOnServer}) => {
    // STATES
    ...
    // EFFECT TO SET THE DATA ON THE FORM
    React.useEffect(() => {
        if (mediaDataOnServer) {
            setCourse({
                ...
                sectionId: mediaDataOnServer.sectionId,
                mediaOrder: mediaDataOnServer.mediaOrder,
                file: [],
            })
        }
    }, [mediaDataOnServer])
    ...
    const handleSubmit = (e) => {
        ...
        if (!course.mediaType || !course.mediaTitle || !course.paymentType || !course.sectionType || (!course.courseId && course.mediaType === 'course') || !course.sectionId || !course.mediaOrder) {
    ...
    return (
        <>
            <form onSubmit={handleSubmit} className={"col-12 card"}>
                <h1 className="text-2xl mb-5 uppercase">Edit Media</h1>
